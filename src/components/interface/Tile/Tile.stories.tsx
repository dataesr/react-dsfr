...
SimpleTile.args = {
  children: [<TileBody title="Titre MD bold">Description</TileBody>],
};
...
SimpleTileWithImage.args = {
  children: [
    <TileBody title="Titre MD bold">Tuile avec image</TileBody>,
...
HorizontalTile.args = {
  children: [<TileBody title="Titre MD bold">Tuile horizontale</TileBody>],
  horizontal: true,
};
...
HorizontalMDTile.args = {
  children: [<TileBody title="Titre MD bold">Tuile horizontale MD</TileBody>],
...
VerticalMDTile.args = {
  children: [<TileBody title="Titre MD bold">Tuile verticale MD</TileBody>],
  verticalMedium: true,
};
