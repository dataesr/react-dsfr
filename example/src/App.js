            ...
            <Switch>
                ...
                <Route exact path="/">
                    <Container role="main">
                        ...
                        <Row>
                            <Col>
                                <TagGroup>
                                    ...
                                    <Tag size="sm" as="span" icon="ri-arrow-right-line" iconPosition="left">Label
                                        tag</Tag>
                        ...
                        <Row>
                            <Col>
                                <SimpleTable tableClassName="tableClassName" tableID="tableID-1" caption="Simple Table"
                                             data={data}/>
                            </Col>
                        </Row>
                            ...
                            <Col n="sm-12" className="fr-col-md-3">
                                <SideMenu title="Titre de rubrique" buttonLabel="Dans cette rubrique">
                                    <SideMenuItem title="Niveau 1">
                                        <SideMenuLink href="/" asLink={<RouterLink to="mySideMenuLink"/>}>Accès direct
                                            niveau
                                            2</SideMenuLink>
                            ...
                            <Col>
                                <Tabs>
                                    <Tab label="Label tab #1">
                                        <h3>Content tab #1</h3>
                                        <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corporis dolorem
                                            est
                                            ex fugiat
                                            minima minus natus quos ratione. Adipisci, consequatur obcaecati porro
                                            soluta
                                            ullam ut.
                        ...
                        <Row>
                            ...
                            <Col>
                                <Button icon="ri-alert-fill" iconPosition="right" title="title">icon on the
                                    right</Button>
                            </Col>
                            <Col>
                        ...
                        <Row>
                            <Col>
                                <Skiplinks>
                                    <SkiplinkItem asLink={<RouterLink to="/mySkiplinkItem"/>}>Accéder au
                                        contenu</SkiplinkItem>
